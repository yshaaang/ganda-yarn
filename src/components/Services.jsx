...
const Services = () => (
  ...
  >
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
      <div className='card h-65 w-64 shadow-md rounded-xl mr-7 mb-7 border border-[#d9d9d9]'>
        <figure className='px-10 pt-10'>
          <img src={fastdelivery} alt='Fast-Delivery' />
        </figure>
        <div className='card-body items-center text-center'>
          <h2 className='card-title text-[#3EADCF] font-bold'>Fast Delivery</h2>
      ...
      <div className='card h-65 w-64 shadow-md rounded-xl mr-7 mb-7 border border-[#d9d9d9]'>
        ...
        <div className='card-body items-center text-center'>
          <h2 className='card-title text-[#3EADCF] font-bold'>
            Secured Payment
          </h2>
