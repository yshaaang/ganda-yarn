...
import {
  Flora_Tote_Bag_mint_green,
  Patterned_Tote_bag_brown,
          ...
          <div className='group relative'>
            ...
            <div className='mt-4 flex justify-between'>
              <div>
                ...
                <p className='mt-1 text-sm text-gray-500'>Green, Brown</p>
              </div>
            </div>
            <div className='card-actions justify-between'>
              <h1 className='font-poppins font-medium py-3 text-[#ff55ee]'>
          ...
          <div className='group relative'>
            ...
            <div className='mt-4 flex justify-between'>
              <div>
                ...
                <p className='mt-1 text-sm text-gray-500'>Brown, White, Gray</p>
              </div>
            </div>
            <div className='card-actions justify-between'>
              <h1 className='font-poppins font-medium py-3 text-[#ff55ee]'>
