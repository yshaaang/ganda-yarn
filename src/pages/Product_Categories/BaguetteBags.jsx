...
export default function baguetteBagsOverview() {
  const [selectedSize, setSelectedSize] = useState(baguetteBags.variants[2]);
      ...
      <div className='pt-6'>
        ...
        <div className='mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8'>
          <div className='aspect-w-3 aspect-h-4 hidden overflow-hidden rounded-lg lg:block'>
            <img
              src={baguetteBags.images[0].src}
              alt={baguetteBags.images[0].alt}
              className='h-full w-full object-cover object-center'
            />
          </div>
          <div className='aspect-w-3 aspect-h-4 hidden overflow-hidden rounded-lg lg:block'>
            <img
              src={baguetteBags.images[1].src}
              alt={baguetteBags.images[1].alt}
              className='h-full w-full object-cover object-center'
            />
          </div>
          <div className='aspect-w-4 aspect-h-5 sm:overflow-hidden sm:rounded-lg lg:aspect-w-3 lg:aspect-h-4'>
            <img
              src={baguetteBags.images[2].src}
              alt={baguetteBags.images[2].alt}
              className='h-full w-full object-cover object-center'
            />
          </div>
        </div>
        ...
        <div className='mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24'>
          ...
          <div className='mt-4 lg:row-span-3 lg:mt-0'>
            ...
            <p className='mt-7 text-sm font-medium text-gray-500'>
              Total Stocks: {totalStocks.totalCount}
              <p>'Variant' Stock: {totalStocks.totalCount}</p>
            </p>
              ...
              <div className=''>
                ...
                >
                  ...
                  <div className='grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4'>
                    {baguetteBags.variants.map((size) => (
                      <RadioGroup.Option
                        key={size.name}
                        value={size}
            ...
            <div className='mt-10'>
              ...
              <div className='mt-4'>
                <ul role='list' className='list-disc space-y-2 pl-4 text-sm'>
                  {baguetteBags.highlights.map((highlight) => (
