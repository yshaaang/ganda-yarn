...
import {
  HandSanitizer_Fruits,
  HandSanitizer_SimpleDesign,
} from '../../assets/gy_products/Hand Sanitizer Holder';

const HandSanitizerHolder = () => {
  return (
        ...
        <div class='mt-6 mb-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8'>
          <div class='group relative'>
            <div class='min-h-80 aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none lg:h-80'>
              <img
                src={HandSanitizer_SimpleDesign}
                alt='Hand Sanitizer Simple'
              ...
              <div>
                <h3 class='text-sm text-gray-700'>
                  <a href='#'>
                    ...
                    Hand Sanitizer in Simple Design
                  </a>
                </h3>
          ...
          <div class='group relative'>
            <div class='min-h-80 aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none lg:h-80'>
              <img
                ...
                alt='Hand Sanitizer Fruit Design'
                class='h-full w-full object-cover object-center lg:h-full lg:w-full cursor-pointer hover:opacity-75'
              />
            </div>
            <div class='mt-4 flex justify-between'>
              <div>
                <h3 class='text-sm text-gray-700'>
                  <a href='#'>
                    <span aria-hidden='true' class=''></span>
                    Hand Sanitizer in Fruit Design
                  </a>
                </h3>
                <p class='mt-1 text-sm text-gray-500'> </p>
              </div>
...
export default HandSanitizerHolder;
