...
import {
  Chapstickholders_pastel,
  Lip_balm_Holder_DarkerShade,
} from '../../assets/gy_products/Lip Balm Holder';
        ...
        <div className='mt-6 mb-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8'>
          <div className='group relative'>
            <div className='min-h-80 aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none lg:h-80'>
              <img
                src={Chapstickholders_pastel}
                alt='Lip Balm Holder Pastel'
              ...
              <div>
                <h3 className='text-sm text-gray-700'>
                  <a href='#'>
                    ...
                    Lip Balm Holder in Pastel Shades
                  </a>
                </h3>
          ...
          <div className='group relative'>
            <div className='min-h-80 aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none lg:h-80'>
              <img
                ...
                alt='Lip Balm Holder in Dark Shades'
                className='h-full w-full object-cover object-center lg:h-full lg:w-full cursor-pointer hover:opacity-75'
              />
            </div>
            <div className='mt-4 flex justify-between'>
              <div>
                <h3 className='text-sm text-gray-700'>
                  <a href='#'>
                    <span aria-hidden='true' className=''></span>
                    Lip Balm Holder in Dark Shades
                  </a>
                </h3>
                <p className='mt-1 text-sm text-gray-500'>
