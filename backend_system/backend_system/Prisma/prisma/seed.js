...
const products = [
  ...
  },
  {
    ...
    name: 'Phone Holder',
    description:
      "The Ganda Yarn's Crochet Phone Holder is a functional and stylish accessory designed to securely hold your phone. The adjustable strap can be customized to your preferred length (long or short)  and can be worn around your neck or across your body. Available in a range of colors, it's a great accessory for everyday use and can keep your phone safe and within reach. This durable and attractive phone holder is a must-have for anyone looking for a practical and stylish solution for keeping their phone safe and accessible.",
  ...
  },
  {
    ...
    name: 'Wallet',
    description:
      "The Ganda Yarn's Crochet Wallet has a personalized touch, made with high-quality cotton yarns for durability and longevity. The wallet can be personalized with a range of color options to match the recipient's personal style which is perfect gift to someone special.",
  ...
  },
  {
    ...
    name: 'Flora Tote Bag',
    description:
      "Ganda Yarn's Flora Tote Bag will provide a dash of whimsy to your everyday look. The classic tote bag form is given a whimsical twist by the lovely flower pattern, making it ideal for days in the spring and summer.",
  ...
  },
  {
    ...
    description:
      "Ganda yarn's Vintage Tote Bag is a one-of-a-kind item that you'll treasure for years to come for its exquisite vintage design that lends a touch of timeless appeal to the traditional tote bag style, making it ideal for special events as well as everyday usage.",
...
const product_attributes = [
  ...
  },
  {
    ...
    product_id: '4',
    variant: 'Bee',
    image_link: 'https://i.imgur.com/HOmBtAV.jpg',
    price: 275,
    stock: 12,
    created_at: new Date().toISOString(),
    modified_at: null,
...
const reviews = [
  {
    ...
    rate: 5,
    comment:
      "The crochet tulip keychain is an adorable and unique accessory that would make a perfect addition to any set of keys or purse. Here's my 5-star rating because of its quality, design, versatility, uniqueness, and affordability.",
  ...
  },
  {
    ...
    rate: 5,
    comment:
      'I had a highly positive experience with the wallet. I likely found the design, quality, and functionality of the wallet to be exceptional, and I may have also appreciated the craftsmanship and attention to detail that went into making it.',
    created_at: new Date(2022, 9, 10, 15, 30, 0).toISOString(),
    modified_at: null,
  },
  {
    ...
    rate: 5,
    comment:
      "Despite knowing that a crochet yarn is soft, it still made my phone safe with this phone holder that the seller made. It's high quality and durable. Thank you seller. <3",
  ...
  },
  {
    ...
    rate: 4,
    comment:
      "I kind of like it, but I feel like it's too long for a keychain because of its tail. Nevertheless, it's still cute looking in my wallet.",
  ...
  },
  {
    ...
    rate: 5,
    comment:
      "It's so cute! My phone really fits in this item that the seller made. Thank you so much seller!",
    created_at: new Date(2022, 11, 1, 9, 45, 30).toISOString(),
    modified_at: null,
  },
  {
    ...
    rate: 5,
    comment:
      'The design on the cow design is so good. The quality of it is really great for its price. Thank you so much seller.',
  ...
  },
  {
    ...
    rate: 5,
    comment:
      'I like pink! I like tulip! This is so cute! Thank you so much seller!',
    created_at: new Date(2022, 11, 20, 17, 0, 0).toISOString(),
    modified_at: null,
  },
  {
    ...
    rate: 5,
    comment:
      'This is so cute and durable! And I like pink as well! Thank you so much seller!',
    created_at: new Date(2022, 11, 20, 17, 0, 0).toISOString(),
    modified_at: null,
  },
  {
    ...
    rate: 5,
    comment:
      'This is so cute. It fits well on my pink wallet. It looks durable as well. Thank you so much seller!',
    created_at: new Date(2022, 11, 31, 23, 59, 59).toISOString(),
    modified_at: null,
  },
  {
    ...
    rate: 5,
    comment:
      'Bought the blue variant. It really looks good and fits a decent amount of coins while being portable as it can fit on my pocket. Thank you so much seller!',
    created_at: new Date(2022, 11, 31, 23, 59, 59).toISOString(),
    modified_at: null,
  },
];
